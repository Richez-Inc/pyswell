...
from pyswell.models.webhooks import Webhooks
...
class TestEvents(unittest.TestCase):
    ...
    def test_webhook_list_events(self):
        ...
        webhook_model._swell._session.get.assert_called_once_with(
            url="https://store_id:api_key/events:webhooks/", params={"sort": "asc"}
        )
