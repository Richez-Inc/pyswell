...
from pyswell.models.base import Base
import logging
...
class TestBaseClass(unittest.TestCase):
    ...
    def setUp(cls):
        ...
        swell = SwellMock()
        base_model = Base(
            swell, name, endpoint=endpoint, required_fields=required_fields
        )
    ...
    def test_list_method_mock(self):
        ...
        base_model._swell._session.get.assert_called_once_with(
            url="https://store_id:api_key/mock", params=params
        )
    ...
    def test_get_method_mock(self):
        ...
        base_model._swell._session.get.assert_called_once_with(
            url=f"https://store_id:api_key/mock/{id}", params=params
        )
    ...
    def test_update_method_mock(self):
        ...
        base_model._swell._session.put.assert_called_once_with(
            url=f"https://store_id:api_key/mock/{id}", json=params
        )
    ...
    def test_delete_method_mock(self):
        ...
        base_model._swell._session.delete.assert_called_once_with(
            url=f"https://store_id:api_key/mock/{id}"
        )
